...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--hr-path", type=Path, default=Path("C:/Users/SAKA/Downloads/DT16-1_hr/WBI2017_Benedenrijn_16-2_v04b") #C:\Users\SAKA\Downloads\DT16-1_hr\WBI2017_Benedenrijn_16-2_v04b
    )
    ...
    parser.add_argument("--dijktraject", type=str, default="16-2") # hier aanpassen voor dijktraject 16-2 is key naar TRAJECT_PROPERTIES in traject_normering.py
